<script lang="ts">
  ...
  import { isBrowser, routesv2 } from '$lib/config';
...
<svelte:head>
  ...
  {@html `<script>document.documentElement.dataset.theme=localStorage.getItem('theme');document.documentElement.dataset.version='v2';</script>`}
</svelte:head>
