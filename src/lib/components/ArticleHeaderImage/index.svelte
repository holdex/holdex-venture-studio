<script lang="ts">
  ...
  const defaultClasses =
    'smDown:relative smDown:top-0 absolute bottom-0 left-1/2 -translate-x-1/2 text-title-l font-satoshi text-center smDown:py-0 xs:text-title-s dark:text-white smDown:text-black text-white w-full';
